...
public class _TupleEquivalenceClassRelation implements Serializable{
    ...
    /**
     * Computes the intersection of this tuple equivalence class relation with another,
     * returning a {@link BitSet} representing the attributes on which they agree.
     *
     * @param other another {@link _TupleEquivalenceClassRelation} to intersect with
     * @return {@link BitSet} where set bits correspond to attributes present in both relations
     */
