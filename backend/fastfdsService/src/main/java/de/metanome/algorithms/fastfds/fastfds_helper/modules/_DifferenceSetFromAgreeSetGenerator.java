...
/**
 * Generates difference sets {@link _DifferenceSet} directly from agree sets {@link _TupleEquivalenceClassRelation}
 * for functional dependency discovery in Spark.
 */
public class _DifferenceSetFromAgreeSetGenerator implements Serializable{
     ...
     * Constructor
     *
     * @param relationships mapping of tuple IDs to their equivalence class relations
     * @param numOfAttributes {@link Integer} total number of attributes
     */
    ...
    /**
     * Comparator for LongList used to order partitions by size (descending) and lexicographically.
     */
    ...
    /**
     * Compute difference sets using a "bottleneck" strategy without separately creating {@link de.metanome.algorithms.fastfds.fastfds_helper.modules.container._AgreeSet}.
     *
     * @param partitions {@link JavaPairRDD} of stripped partitions
     * @return {@link JavaRDD} of difference sets
     */
    public JavaRDD<_DifferenceSet> executeBottleneck(JavaPairRDD<Integer, _StrippedPartitionSpark> partitions){
        ...
        return partitions
            ...
            .flatMap(tuple -> {
                ...
                treePartitions.addAll(tuple._2);
    ...
    /**
     * Checks whether a list is a subset of previously seen partitions using an index map.
     *
     * @param currentList {@link LongList} to check
     * @param indexOfPartitionWithLong mapping of element -> positions
     * @return {@code true} if currentList is a subset, {@code false} otherwise
     */
    ...
    /**
     * Intersects two LongLists, removing elements from the first that are not in the second.
     *
     * @param positions {@link LongList} to be updated
     * @param indexSet {@link LongList} to intersect with
     */
