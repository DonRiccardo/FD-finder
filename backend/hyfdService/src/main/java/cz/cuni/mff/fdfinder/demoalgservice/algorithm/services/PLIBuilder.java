...
package cz.cuni.mff.fdfinder.demoalgservice.algorithm.services;

import cz.cuni.mff.fdfinder.demoalgservice.algorithm.model.PositionListIndex;
import cz.cuni.mff.fdfinder.demoalgservice.algorithm.model._Input;
import cz.cuni.mff.fdfinder.demoalgservice.algorithm.model._Input;
...
public class PLIBuilder {
    ...
    protected List<HashMap<String, IntArrayList>> calculateClusterMaps(_Input relationalInput, int numAttributes) /*throws InputIterationException */{
            ...
            List<Tuple2<Row, Long>> data = relationalInput.getDataAsList();
