...
import cz.cuni.mff.fdfinder.hyfdservice.algorithm.model._FunctionalDependency._ColumnCombination;
import cz.cuni.mff.fdfinder.hyfdservice.algorithm.model._FunctionalDependency._ColumnIdentifier;
...
*/
	...
	public void addFunctionalDependenciesInto(List<_FunctionalDependency> functionalDependencies, BitSet lhs, ObjectArrayList<_ColumnIdentifier> columnIdentifiers, List<PositionListIndex> plis) {
		for (int rhs = this.rhsFds.nextSetBit(0); rhs >= 0; rhs = this.rhsFds.nextSetBit(rhs + 1)) {
