package cz.cuni.mff.fdfinder.hyfdservice.algorithm;

import cz.cuni.mff.fdfinder.hyfdservice.algorithm.model._CSVInput;
...
import cz.cuni.mff.fdfinder.hyfdservice.algorithm.model._JSONInput;
import cz.cuni.mff.fdfinder.hyfdservice.model.FileFormat;
import de.metanome.algorithms.hyfd.HyFDSparkAlgorithm;
...
public class HyFDSpark {
    ...
    public HyFDSpark (JavaSparkContext context, SparkSession spark, Path filePath, String tableName,
                     int skip, int limit, int maxLhs, FileFormat fileFormat, boolean header, String delim) throws UnsupportedOperationException{

        HyFDSpark.context = context;
        HyFDSpark.spark = spark;
    ...
    public List<_FunctionalDependency> startAlgorithm() throws Exception {
        ...
        HyFDSparkAlgorithm main = new HyFDSparkAlgorithm(input, maxLhs, context);
        main.execute();
