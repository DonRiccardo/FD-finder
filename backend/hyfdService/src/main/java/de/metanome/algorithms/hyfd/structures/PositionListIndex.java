...
public class PositionListIndex implements Serializable {
	...
	/**
	 * Returns the attribute (column index) represented by this PLI.
	 *
	...
	/**
	 * Returns the clusters of this PLI.
	 *
	 * @return the list of {@link IntArrayList} clusters
	 */
	...
	/**
	 * Returns the total number of non-unique values in the column.
	 *
	 * @return number of non-unique values
	 */
	...
	/**
	 * Constructs a {@code PositionListIndex} for a given attribute and its clusters.
	 *
	 * @param attribute the column index this PLI represents
	 * @param clusters the clusters of record positions
	 */
	...
	/**
	 * Counts the total number of non-unique values in a list of clusters.
	 *
	 * @param clusters list of clusters
	 * @return sum of cluster sizes
	 */
	...
	/**
	 * Computes the intersection of this PLI with multiple other PLIs.
	 *
	 * @param plis array of inverted PLIs for intersection
	 * @return a new {@link PositionListIndex} representing the intersection
	 */
	...
	/**
	 * Computes the intersection of this PLI with another PLI.
	 *
	 * @param otherPLI an array representing another PLI
	 * @return a new {@link PositionListIndex} representing the intersection
	 */
	...
	/**
	 * Builds a nested map representing intersections between this PLI and another PLI.
	 *
	 * @param hashedPLI the other PLI represented as an int array
	 * @return nested map: cluster1Id -> cluster2Id -> list of recordIds
	 */
	...
	/**
	 * Checks if this PLI refines a RHS attribute over compressed records.
	 *
	 * @param compressedRecords compressed representation of all records
	 * @param rhsAttr index of the RHS attribute
	 * @return true if the LHS represented by this PLI refines the RHS
	 */
	...
	/**
	 * Checks if all records in a cluster map to the same RHS cluster (compressed records).
	 *
	 * @param compressedRecords compressed records array
	 * @param rhsAttr index of RHS attribute
	 * @param cluster cluster to probe
	 * @return true if all records point to the same cluster, false otherwise
	 */
	...
	/**
	 * Checks if this PLI refines a RHS attribute over inverted PLI array.
	 *
	 * @param rhsInvertedPli inverted PLI array
	 * @return true if the LHS represented by this PLI refines the RHS
	 */
	...
	/**
	 * Checks if all records in a cluster map to the same RHS cluster (inverted PLI array).
	 *
	 * @param rhsInvertedPli inverted PLI array
	 * @param cluster cluster to probe
	 * @return true if all records point to the same cluster, false otherwise
	...
	/**
	 * Checks which RHS attributes are refined by a LHS for compressed records.
	 *
	 * @param compressedRecords compressed representation of all records
	 * @param lhs bitset representing the LHS attributes
	 * @param rhs bitset representing the RHS attributes
	 * @param comparisonSuggestions list to store suggested comparisons for validation
	 * @return bitset of refined RHS attributes
	 */
	...
	/**
	 * Checks which RHS attributes are refined by a LHS for inverted PLI array.
	 *
	 * @param invertedPlis inverted PLI array
	 * @param lhs bitset representing the LHS attributes
	 * @param rhs bitset representing the RHS attributes
	...
	/**
	 * Checks if all subclusters of this PLI point to the same RHS cluster over compressed records.
	 *
	 * @param compressedRecords compressed representation of all records
	 * @param lhs bitset representing the LHS attributes
	 * @param rhs array representing RHS cluster IDs
	 * @return true if refinement holds for all clusters
	 */
	...
	/**
	 * Checks if all subclusters of this PLI point to the same RHS cluster over inverted PLIs.
	 *
	 * @param lhsInvertedPlis inverted PLIs representing LHS
	 * @param rhs array representing RHS cluster IDs
	 * @return true if refinement holds for all clusters
	 */
	...
	/**
	 * Builds a cluster identifier from a LHS and a record.
	 *
	 * @param lhs the LHS attributes as a BitSet
	 * @param lhsSize number of attributes in LHS
	 * @param record the compressed record
	 * @return a {@link ClusterIdentifier} or {@code null} if any cluster ID < 0
	 */
	...
	/**
	 * Builds a cluster identifier for a single record from inverted PLIs.
	 *
	 * @param recordId index of the record
	 * @param invertedPlis inverted PLI array
	 * @param lhs bitset representing LHS attributes
	 * @param lhsSize number of LHS attributes
	 * @return a cluster identifier or null if any cluster ID < 0
	 */
	...
	/**
	 * Builds a cluster identifier as an IntArrayList for a record.
	 *
	 * @param recordId index of the record
	 * @param lhsInvertedPlis inverted PLIs
	 * @return IntArrayList representing the cluster identifier, or null if any cluster ID < 0
	 */
	...
	/**
	 * Converts clusters to a list of sets for equality and hash code calculations.
	 *
	 * @param listCluster list of IntArrayList clusters
	 * @return list of IntOpenHashSet clusters
	 */
