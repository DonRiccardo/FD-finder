package cz.cuni.mff.fdfinder.distlatservice.algorithm;

import cz.cuni.mff.fdfinder.distlatservice.algorithm.model._CSVInput;
import de.metanome.algorithms.depminer.depminer_helper.modules.container._FunctionalDependency;
import cz.cuni.mff.fdfinder.distlatservice.algorithm.model._Input;
import cz.cuni.mff.fdfinder.distlatservice.algorithm.model._JSONInput;
import cz.cuni.mff.fdfinder.distlatservice.model.FileFormat;
import de.metanome.algorithms.tane.DistLatSparkAlgorithm;
...
public class DistLatSpark {
    ...
    public DistLatSpark(JavaSparkContext context, SparkSession spark, Path filePath, String tableName,
                        int skip, int limit, int maxLhs, FileFormat fileFormat, boolean header, String delim) throws IOException {

        DistLatSpark.context = context;
        DistLatSpark.spark = spark;
    ...
    public HashSet<_FunctionalDependency> startAlgorithm() {
        ...
        DistLatSparkAlgorithm main = new DistLatSparkAlgorithm(input, maxLhs, context);
        main.execute();
